...
modality = 'Fundus' # e.g., 'Dermoscopy 
anatomy = 'FIVES'  # e.g., 'SkinCancer'
img_name_suffix = '.png' 
gt_name_suffix = '.png' 
prefix = modality + '_' + anatomy + '_'
save_suffix = '.npy' 
image_size = 1024
img_path = '/mnt/FIVES/train_npy/imgs' # path to the images
gt_path = '/mnt/FIVES/train_npy/gts' # path to the corresponding annotations
npy_path = '/mnt/FIVES/train_npy' + prefix[:-1] # save npy path e.g., MedSAM/data/npy/; don't miss the `/`
